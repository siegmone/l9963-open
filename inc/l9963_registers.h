...
typedef enum {
    L9963_DEV_GEN_CFG_ADDR        = 0x01,
    L9963_fastch_baluv_ADDR       = 0x02,
    L9963_Bal_1_ADDR              = 0x03,
    L9963_Bal_2_ADDR              = 0x04,
    L9963_Bal_3_ADDR              = 0x05,
    L9963_Bal_4_ADDR              = 0x06,
    L9963_Bal_5_ADDR              = 0x07,
    L9963_Bal_6_ADDR              = 0x08,
    L9963_Bal_7_ADDR              = 0x09,
    L9963_Bal_8_ADDR              = 0x0A,
    L9963_VCELL_THRESH_UV_OV_ADDR = 0x0B,
    L9963_VBATT_SUM_TH_ADDR       = 0x0C,
    L9963_ADCV_CONV_ADDR          = 0x0D,
    L9963_NCYCLE_PROG_1_ADDR      = 0x0E,
    L9963_NCYCLE_PROG_2_ADDR      = 0x0F,
