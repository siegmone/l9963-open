...
L9963_Status L9963_SetDevID(L9963_Handle *handle, uint8_t dev_id) {
    ...
    status = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id & 0b00011111, L9963_DEV_GEN_CFG_ADDR, &to_write, 50);
...
L9963_Status L9963_SetCommTimeout(L9963_Handle *handle, L9963_CommTimeoutEnum commTimeout, uint8_t dev_id) {
	 ...
	 */
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_fastch_baluv_ADDR, &fastch_baluv_reg, 50);
    L9963_ASSERT_STATUS(status);
    ...
    status                                    = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_fastch_baluv_ADDR, &fastch_baluv_reg, 50);
...
L9963_Status L9963_SetEnabledCells(L9963_Handle *handle, uint8_t dev_id, uint16_t en_cells_mask) {
    ...
    status = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_VCELLS_EN_ADDR, &vcells_en_reg, 50);
...
L9963_Status L9963_StartOnDemandConversion(L9963_Handle *handle, uint8_t dev_id, L9963_CellConvTimeEnum adc_filter_soc, uint8_t gpio_conv_en, uint8_t hwsc) {
    ...
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_ADCV_CONV_ADDR, &ADCV_CONV_reg, 50);
    L9963_ASSERT_STATUS(status);
    ...
    status = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_ADCV_CONV_ADDR, &ADCV_CONV_reg, 50);
...
L9963_Status L9963_ReadBatteryVoltage(L9963_Handle *handle, uint8_t dev_id, uint16_t *vbatt_monitor, uint32_t *vbatt_sum) {
    ...
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_VBATTDIV_ADDR, &vbattdiv_reg, 50);
    L9963_ASSERT_STATUS(status);

    /* Perform VSUM_BATT register read */
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_VSUMBATT_ADDR, &vsumbatt_reg, 50);
    L9963_ASSERT_STATUS(status);
...
L9963_Status L9963_EnableDisableCoulombCounting(L9963_Handle *handle, uint8_t dev_id, uint8_t enable) {
    ...
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_CSA_GPIO_MSK_ADDR, &csa_gpio_msk_reg, 50);
    L9963_ASSERT_STATUS(status);

    csa_gpio_msk_reg.CSA_GPIO_MSK.CoulombCounter_en = enable & 1U;
    status                                          = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_CSA_GPIO_MSK_ADDR, &csa_gpio_msk_reg, 50);
...
L9963_Status L9963_GetCoulombCounterSamples(L9963_Handle *handle, uint8_t dev_id, uint16_t *n_samples) {
    ...
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_CoulCntrTime_ADDR, &CoulCntrTime_reg, 50);
    L9963_ASSERT_STATUS(status);
...
L9963_Status L9963_SetBalancingCells(L9963_Handle *handle, uint8_t dev_id, uint16_t bal_mask) {
    ...
    /* Cells from 14 to 7 */
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_BalCell14_7act_ADDR, &BalCell14_7act_reg, 50);
    L9963_ASSERT_STATUS(status);
    ...
    status = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_BalCell14_7act_ADDR, &BalCell14_7act_reg, 50);
    L9963_ASSERT_STATUS(status);

    /* Cells from 6 to 1 */
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_BalCell6_1act_ADDR, &BalCell6_1act_reg, 50);
    L9963_ASSERT_STATUS(status);
    ...
    status = L9963_Driver_RegisterWrite(&handle->drv_handle, dev_id, L9963_BalCell6_1act_ADDR, &BalCell6_1act_reg, 50);
...
L9963_Status L9963_ReadContinousCurrent(L9963_Handle *handle, uint8_t dev_id, uint32_t *current) {
    ...
    status = L9963_Driver_RegisterRead(&handle->drv_handle, dev_id, L9963_Ibattery_calib_ADDR, &Ibattery_calib_reg, 50);
    L9963_ASSERT_STATUS(status);
